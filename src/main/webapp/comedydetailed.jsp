...
%>
    ...
    <main class="main">
        <div class="container">
            <div class="img_con">
                <img src="/images/Comedy_4.jpg" alt="">
            </div>
        </div>
        <div class="text_1"> <h2>Name : Why I Hate Romance</h2></div>
        <div class="text_1"><h2>Author Name : Dai Alanye</h2></div>
        <div class="text_1"><h2>Category : Comedy</h2></div>
        <div class="text_2">
            <a href="/pdf/Comedy_4.pdf" target="_blank">Read  |</a>
            <a href="${pageContext.request.contextPath}/down_2" target="_blank">Download</a>
        </div>
    </main>

...
%>
    ...
    <main class="main">
        <div class="container">
            <div class="img_con">
                <img src="/images/Horror_4.jpg" alt="">
            </div>
        </div>
        <div class="text_1"> <h2>Name : Devil of Ghost Hour</h2></div>
        <div class="text_1"><h2>Author Name : Coral Russell</h2></div>
        <div class="text_1"><h2>Category : Horror</h2></div>
        <div class="text_2">
            <a href="/pdf/Horror_4.pdf" target="_blank">Read  |</a>
            <a href="${pageContext.request.contextPath}/down_1" target="_blank">Download</a>
        </div>
    </main>
